...
//     var data = await fetchExamData()
//     // console.log("yooop:",data)
...
//     function generateQuestionHTML(questionObject, index) {
//       let html = `
//         <div class="question-container">
...
//       questionObject.Options.forEach((option, optionIndex) => {
//         html += `
//           <div class="option">
//             <input type="radio" name="question-${index}" value="${option}" id="q${index}-option${optionIndex}">
//             <label for="q${index}-option${optionIndex}">${option}</label>
...
//       data.forEach((questionObject, index) => {
//         questionsContainer.innerHTML += generateQuestionHTML(questionObject, index);
//       });
//     }
...
//           // Redirect user to the provided page after submission
//           redirectToProvidedPage();
