...
function makePayment(paymentRefNo,studentId,studentPhoneNo,studentName, email) {
    FlutterwaveCheckout({
...
document.querySelector(".submit")
    .addEventListener("click", async ()=>{
        try{
            ...
            makePayment(email= EmailpaymentRefNo=ref,studentPhoneNo=phone,studentName=name,studenttId=studenttId)
        }
        catch(Error){
            console.log(Error)
        }
